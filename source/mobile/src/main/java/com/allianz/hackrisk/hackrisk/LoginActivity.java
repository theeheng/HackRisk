...
public class LoginActivity extends PlusBaseActivity implements LoaderCallbacks<Cursor>  {
    ...
    private static final String[] DUMMY_CREDENTIALS = new String[]{
            "heng@allianz.com:hello", "bar@example.com:world"
    };
    ...
    /*public void HandleUpdate() {
        ...
        if (mLastLocation != null) {
            ...
            try {
                ...
                locationLabel = getResources().getString(R.string.myLocation);

                locationLabel = locationLabel + ": " + currentAddress.getLocality() + ",  "+ currentAddress.getCountryName();
...
*/
    ...
    /*
    public void HandleCrimeUpdate(ArrayList<CrimeApiResult> crimeApiResults) {
...
*/
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean>  {
        ...
        UserLoginTask(Context appContext,String email, String password) {
